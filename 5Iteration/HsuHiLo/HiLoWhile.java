...
detect the smallest integer value and the largest integer value. Then, the
program will repeat the values back to the user. This program uses a while loop.
